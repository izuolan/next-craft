export const lang = {
  zh: {
    ...
    HERO: {
      ...
      GITHUB_BUTTON_DES: '开源项目',
      DOCS_BUTTON: '文档',
      DOCS_BUTTON_DES: '部署说明',
      NOTICE_TEXT: '本页面根据 Craft.do 文档自动生成'
    },
    FOOTER: {
      COPYRIGHT_START: '本站原创内容基于 ',
      COPYRIGHT_NAME: 'CC BY-SA 4.0',
      COPYRIGHT_LINK: 'https://creativecommons.org/licenses/by/4.0/',
      COPYRIGHT_END: ' 共享, 转载注明出处.'
    },
    ERROR: {
      MESSAGE: '一些错误使我们在此相遇',
      TITLE: '页面无法找到',
      HELP_TEXT: '请尝试刷新页面, 若有疑问请联系我.',
      BACK_TO_HOME: '返回首页',
  ...
  en: {
    ...
    HERO: {
      ...
      GITHUB_BUTTON: 'Github',
      GITHUB_BUTTON_DES: 'Open source',
      DOCS_BUTTON: 'Detail',
      DOCS_BUTTON_DES: 'Deploy docs',
      NOTICE_TEXT: 'Automatically generated from the Craft.do page'
    },
    FOOTER: {
      COPYRIGHT_START: 'This page is licensed under the ',
      COPYRIGHT_NAME: 'CC BY-SA 4.0',
      COPYRIGHT_LINK: 'https://creativecommons.org/licenses/by/4.0/',
      COPYRIGHT_END: '.'
    },
    ERROR: {
      ...
      HELP_TEXT: 'Please try to refresh the page, if you have any questions, contact me.',
